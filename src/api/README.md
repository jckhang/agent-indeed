...
- `docs/BACKEND_API_EXAMPLE_PACKET.md`: canonical `publish -> match -> commit -> reveal -> verify -> award` request/response packet, minimal Node `fetch` snippets, and negative-path examples for issue #11 handoff.
