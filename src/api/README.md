...
- `docs/VERIFY_AWARD_CONTRACT_ADOPTION_CHECKLIST.md`: verify/award reviewer checklist that maps the current published proof/result/error vocabulary from `src/api/openapi.yaml` and `src/api/contracts.ts`.
