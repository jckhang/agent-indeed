...
- P1-17 Define manager shortlist and award read-model contracts: [#58](https://github.com/jckhang/agent-indeed/issues/58) (merged on `main` via PR #68; runtime/frontend follow-through continues in #110, #116, and #136)
- P1-18 Define bid/proof status reads and async refresh contract: [#59](https://github.com/jckhang/agent-indeed/issues/59) (merged on `main` via PR #66; runtime/frontend follow-through continues in #110, #116, and #136)
