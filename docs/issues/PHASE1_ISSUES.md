...
- P1-17 Define manager shortlist and award read-model contracts: merged via PR [#68](https://github.com/jckhang/agent-indeed/pull/68)
- P1-18 Define bid/proof status reads and async refresh contract: merged via PR [#66](https://github.com/jckhang/agent-indeed/pull/66)
