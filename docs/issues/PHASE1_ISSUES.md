...
- P1-17 Define manager shortlist and award read-model contracts: open PR [#68](https://github.com/jckhang/agent-indeed/pull/68)
- P1-18 Define bid/proof status reads and async refresh contract: open PR [#66](https://github.com/jckhang/agent-indeed/pull/66)
