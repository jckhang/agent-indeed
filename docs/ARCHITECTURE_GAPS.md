...
- Manager-side publish/award baseline is documented in `docs/MANAGER_CONSOLE_BASELINE.md`, and the shortlist/award read contracts now exist on `main`; the remaining gap is runtime parity and validation evidence.
