...
- The merged runtime/frontend baseline is on `main` through PR #126 and PR #139; the active convergence risk is now the remaining follow-through on PR #127, PR #129, and the doc queue staying synced via PR #140 and PR #141.
...
- runtime delivery threads (`#115`, `#127`, `#129`, `#120`, `#111`, and blocked follow-through `#11`)
