...
- The merged runtime/frontend baseline is on `main` through PR #126 and PR #139; PR #127 merged on 2026-03-17 at 13:54:46Z, so the active convergence risk is concentrated in PR #129 plus the doc queue staying synced via PR #133, PR #140, and PR #141.
...
- runtime delivery threads (`#115`, blocked `#129`, doc-alignment `#133`, `#120`, `#111`, and blocked follow-through `#11`)
