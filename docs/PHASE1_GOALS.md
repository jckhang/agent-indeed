...
- The runtime fixture pack in `docs/FRONTEND_API_FIXTURE_PACK_2026-03-16.md` keeps publish, shortlist, commit, reveal, verify-handoff, and award-read-blocked examples aligned to the current contract baseline before a real frontend app lands.
