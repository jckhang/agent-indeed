...
- Runtime command/evidence expectations live in `docs/RUNTIME_EXECUTION_HANDOFF.md`; use that handoff contract when issue #196 or issue #11 claims executable progress.
...
- Active follow-through threads for the pivot:
  ...
  - #196 converge the issue #11 backend handoff onto the canonical `main` command and final handoff thread
...
- The canonical command path and evidence handoff into issue #11 are documented in `docs/RUNTIME_EXECUTION_HANDOFF.md`; planning docs should point at that `main` command plus issue #196 / issue #11 instead of transient formatter PR stacks.
