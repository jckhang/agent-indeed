...
- Active follow-through threads for the pivot:
  ...
  - PR #200 as the surviving frontend runtime-consumer alignment thread for the issue #11 evidence lane
...
- The canonical command path and evidence handoff into issue #11 are documented in `docs/RUNTIME_EXECUTION_HANDOFF.md`, `smoke:issue11`, and PR #200; closed formatter/drift work should stay as baseline references or dated snapshots rather than active blockers.
