...
| End-to-end happy path can be demonstrated | Blocked | `docs/PHASE1_GOALS.md`, issue #11, `docs/MVP_E2E_ASSERTION_MATRIX.md` | Needs the remaining M2-M4 contract PRs plus the shared QA handoff work in issue #87, PR #95, PR #96, and issue #101 before E2E issue #11 can turn into executable coverage. |
...
| QA assertion prewrite | issue #101 | The assertion matrix pairs with the handoff pack so issue #87 and issue #11 reuse one ordered set of statuses, error outcomes, and blockers. |
...
| M4 | Award, audit, and beta readiness | Security is merged, but award-read, audit-trace, smoke coverage, QA handoff docs, planning sync, and the new assertion matrix still need to close. |
