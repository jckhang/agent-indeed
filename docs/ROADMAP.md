...
- Keep the merged read-model baseline from PRs #66 and #68 reflected in downstream frontend docs, with PR #122 held to the current `main` contract baseline rather than historical blocker wording.
...
- M1 (2026-03-20): absorb the merged read-model baseline from PRs #66 and #68 and land runnable backend skeleton (#109).
