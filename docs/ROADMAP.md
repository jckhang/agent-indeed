...
- PRs #66 and #68 are now merged on `main`; keep the remaining runtime doc/review follow-through focused on branches like PR #122 that must stay aligned to that merged baseline, rather than treating old contract PRs as current blockers.
...
- M1 (2026-03-20): absorb the newly merged proof/award read contracts into the runtime/frontend handoff docs and land runnable backend skeleton (#109).
