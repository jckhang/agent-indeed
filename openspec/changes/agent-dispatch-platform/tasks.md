...
- [x] 5.15 收敛 issue #11 backend evidence 路径（issue #196），把规划/状态文档统一到 `main` 上的 `smoke:issue11` 命令、`docs/RUNTIME_EXECUTION_HANDOFF.md` 与最终 issue #11 证据线程，移除对临时 formatter PR 栈的稳定锚点依赖。
