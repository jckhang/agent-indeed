...
- 补充 verify/award contract adoption checklist（issue #213），把当前 `main` 上已经发布的验证结果、reason code、错误码与 award carry-over 字段收敛到单一 reviewer handoff，避免继续引用已失真的 PR #133 快照。
