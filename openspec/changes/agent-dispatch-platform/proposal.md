...
- 增补 frontend onboarding follow-through 文档切片，要求 agent 侧 UI 将 bundle upload replay 视为成功路径、直接展示 indexing 回执，并把仍未合入 `main` 的 onboarding smoke/runtime 依赖明确标注为 follow-up 而非既成事实。
