...
- 增补 epic #2 / beta-readiness 文档卫生要求：只把仍然开放的 onboarding upload、issue #11 evidence 与 verify/award follow-through 线程当作活跃 gate 依赖，避免继续引用已关闭 issue。
...
- 更新 epic #2 / beta-readiness 稳定文档，使其只锚定 live onboarding upload、issue #11/issue #206 evidence 与 verify/award 线程，避免 closed blocker 漂移回写。
