...
11. Phase 1 当前冲刺采用 runtime-first 交付
   ...
   - backend 侧补充 `docs/BACKEND_API_EXAMPLE_PACKET.md`，把 merged smoke flow 的 publish/match/commit/reveal/verify/award 请求响应、最小 SDK 片段和核心负面场景固定成一个 QA / beta consumer 可复用的数据包。
